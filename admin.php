...
if (isset($_POST['logout'])) {
    ...
    header('location:index.php');
        ...
        echo '<a href="question.php"><button class="btn btn-outline-secondary btn-sm">Page Question <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-left-text" viewBox="0 0 16 16">
