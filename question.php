...
<?php
session_start();
echo'<a href="question.php"><button class="btn btn-outline-secondary btn-sm">Refresh <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-clockwise" viewBox="0 1 16 16">
